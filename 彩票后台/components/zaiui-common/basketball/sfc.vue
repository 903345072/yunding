<template>
	<view >
		...
		<view style="display: flex;">
			...
			<view style="width: 100%;height: 100%;">
				<view :style="{'line-height':box_height/2+'rpx','border-top':'1px solid #EEEEEE'}" @click="checked('4-6',pl2.split(',')[0])" :class="['item',{'checked':this.check_item['4-6']['checked'] == true}]">
							<view>主胜1~5</view>
							<view>{{pl2.split(',')[0]}}</view>
				</view>
				
				<view :style="{'line-height':box_height/2+'rpx','border-top':'1px solid #EEEEEE'}" @click="checked('4-7',pl2.split(',')[1])" :class="['item',{'checked':this.check_item['4-7']['checked'] == true}]">
					<view>主胜6~10</view>
					<view>{{pl2.split(',')[1]}}</view>
				</view>
				<view :style="{'line-height':box_height/2+'rpx','border-top':'1px solid #EEEEEE'}" @click="checked('4-8',pl2.split(',')[2])" :class="['item',{'checked':this.check_item['4-8']['checked'] == true}]">
					<view>主胜11~15</view>
					<view>{{pl2.split(',')[2]}}</view>
				</view>
				<view :style="{'line-height':box_height/2+'rpx','border-top':'1px solid #EEEEEE'}" @click="checked('4-9',pl2.split(',')[3])" :class="['item',{'checked':this.check_item['4-9']['checked'] == true}]">
					<view>主胜16~20</view>
					<view>{{pl2.split(',')[3]}}</view>
				</view>
				<view :style="{'line-height':box_height/2+'rpx','border-top':'1px solid #EEEEEE'}" @click="checked('4-10',pl2.split(',')[4])" :class="['item',{'checked':this.check_item['4-10']['checked'] == true}]">
					<view>主胜21~25</view>
					<view>{{pl2.split(',')[4]}}</view>
				</view>
				<view :style="{'line-height':box_height/2+'rpx'}" @click="checked('4-11',pl2.split(',')[5])" :class="['item',{'checked':this.check_item['4-11']['checked'] == true}]">
					<view>主胜26+</view>
