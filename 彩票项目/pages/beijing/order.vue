<template >
	<view  >
		...
		<view v-if="can_order() ==true" style="display: flex;width: 100%;justify-content: space-around;margin-top: 30rpx;">
			<view style="display: flex;align-items: center;background-color: white;width: 80%;justify-content: center;padding: 10rpx 0;border-radius: 10rpx;">
	...
	<view style="position: fixed;left: 0;right: 0;bottom: 0;background-color: white;z-index: 999;display: flex;flex-direction: column;">
		...
		<view style="display: flex;justify-content: space-between;align-items: center;padding: 10rpx 20rpx;">
			<view style="display: flex;flex-direction: column;justify-content: center;align-items: center;">
				...
				<view style="color: red;font-size: 25rpx;"  >预测奖金 {{getExpectMaxAward()}}元</view>
			</view>
			...
			<view >
				...
				<view @click="openorderpop()" style="display: inline-block;background: linear-gradient(to right,#97e2e2,#ffaaff);padding: 10rpx 60rpx;border-radius: 20rpx 20rpx;">提交</view>
			</view>
		</view> 
...
<script>
	...
	export default{
		...
		if(jj.length  >=1){
			return (parseFloat(max_jj*this.bei)*0.65).toFixed(2)
		}
