		...
		<view v-if="orderdetail.order_detail_.length>0">
			<view style="display: flex;align-items: center;justify-content: space-between;">
				...
				<view style="color: white;">
					<view style="background-color: #005500;display: inline-block;padding: 4rpx 16rpx;border-radius: 10rpx;margin-right: 10rpx;">{{orderdetail.order_detail_[0][0]["qh"]}}期</view>
					...
					<view style="background-color: #bf8ef0;display: inline-block;padding: 4rpx 10rpx;border-radius: 10rpx;">{{orderdetail.en_type}}</view>
				</view>
			</view>
				...
				<view style="display: flex;background-color: #ebebeb;width: 100%;padding: 5rpx 0;margin-top: 15rpx;">
					...
					<view style="width: 25%;text-align: center;color: grey;">赛果(全)</view>
				</view>
