...
<script>
	export default{
		...
		data(){
			return{
				 arr:{"foot":"竞彩足球","bd":"北京单场","basket":"竞彩篮球","pl3":"排列三","pl5":"排列五","sfc":"胜负彩","renjiu":"任选九"}
			}
		},
		props:{
			expect_min_award:{
